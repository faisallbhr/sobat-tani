<x-app-layout>
    <div id="tabs" class="px-4 sm:px-6 lg:px-8 py-8 w-full max-w-9xl">
        ...
        <ul class="flex gap-4">
            <li onclick="openCity(event, 'tabs-1')" class="tablinks text-slate-900 text-slate-400 cursor-pointer px-2 py-1 rounded-md mb-2 bg-white shadow">Menunggu persetujuan</li>
